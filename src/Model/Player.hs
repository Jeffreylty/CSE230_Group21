...
aceStrategy :: a -> GameBoard -> b -> IO Pos
aceStrategy _ gb _ = do
  if  (b ! (Pos 2 2) /= Just X) &&  (b ! (Pos 2 2) /= Just O)
    ...
    then return (Pos 1 3)
  else if b ! (Pos 1 1) == Just X && b ! (Pos 3 1) == Just X && (Pos 2 1) `elem`(emptyPositions gb)
    then return (Pos 2 1)
  else if b ! (Pos 1 1) == Just X && b ! (Pos 2 1) == Just X && (Pos 3 1) `elem`(emptyPositions gb)
    then return (Pos 3 1)
  else if b ! (Pos 2 1) == Just X && b ! (Pos 3 1) == Just X && (Pos 1 1) `elem`(emptyPositions gb)
    then return (Pos 1 1)
  else if b ! (Pos 3 1) == Just X && b ! (Pos 3 2) == Just X && (Pos 3 3) `elem`(emptyPositions gb)
    then return (Pos 3 3)
  else if b ! (Pos 3 1) == Just X && b ! (Pos 3 3) == Just X && (Pos 3 2) `elem`(emptyPositions gb)
    then return (Pos 3 2)
  else if b ! (Pos 3 2) == Just X && b ! (Pos 3 3) == Just X && (Pos 3 1) `elem`(emptyPositions gb)
    then return (Pos 3 1)
  else if b ! (Pos 1 3) == Just X && b ! (Pos 2 3) == Just X && (Pos 3 3) `elem`(emptyPositions gb)
    then return (Pos 3 3)
  else if b ! (Pos 2 3) == Just X && b ! (Pos 3 3) == Just X && (Pos 1 3) `elem`(emptyPositions gb)
    then return (Pos 1 3)
  else if b ! (Pos 1 3) == Just X && b ! (Pos 3 3) == Just X && (Pos 2 3) `elem`(emptyPositions gb)
    then return (Pos 2 3)
  else if b ! (Pos 1 1) == Just X && b ! (Pos 2 2) == Just X && (Pos 3 3) `elem`(emptyPositions gb)
    then return (Pos 3 3)
  else if b ! (Pos 1 1) == Just X && b ! (Pos 3 3) == Just X && (Pos 2 2) `elem`(emptyPositions gb)
    then return (Pos 2 2)
  else if b ! (Pos 2 2) == Just X && b ! (Pos 3 3) == Just X && (Pos 1 1) `elem`(emptyPositions gb)
    then return (Pos 1 1)
  else if b ! (Pos 1 3) == Just X && b ! (Pos 2 2) == Just X && (Pos 3 1) `elem`(emptyPositions gb)
    then return (Pos 3 1)
  else if b ! (Pos 1 3) == Just X && b ! (Pos 3 1) == Just X && (Pos 2 2) `elem`(emptyPositions gb)
    then return (Pos 2 2)
...
minMaxStrategy :: a -> GameBoard -> b -> IO Pos
...
fillBoard :: GameBoard -> [Cell]
fillBoard b = concat (
    for [1..3] (\i -> do
      for [1..3] (\j -> do
        let pos = Pos i j
        
        if (gbBoard b ! pos) ==  Just X
          then Taken XX
        else if (gbBoard b ! pos) == Just O
          then Taken OO
        else Empty
        )
      ))
