...
aceStrategy _ b _ = do
  if  (b ! (Pos 2 2) /= Just X) &&  (b ! (Pos 2 2) /= Just O)
    then return (Pos 2 2)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 1 3) == Just O && (Pos 1 2) `elem`(emptyPositions b)
    then return (Pos 1 2)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 1 2) == Just O && (Pos 1 3) `elem`(emptyPositions b)
    then return (Pos 1 3)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 3 1) == Just O && (Pos 2 1) `elem`(emptyPositions b)
    then return (Pos 2 1)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 2 1) == Just O && (Pos 3 1) `elem`(emptyPositions b)
    then return (Pos 3 1)
  else if b ! (Pos 2 1) == Just O && b ! (Pos 3 1) == Just O && (Pos 1 1) `elem`(emptyPositions b)
    then return (Pos 1 1)
  else if b ! (Pos 3 1) == Just O && b ! (Pos 3 2) == Just O && (Pos 3 3) `elem`(emptyPositions b)
    then return (Pos 3 3)
  else if b ! (Pos 3 1) == Just O && b ! (Pos 3 3) == Just O && (Pos 3 2) `elem`(emptyPositions b)
    then return (Pos 3 2)
  else if b ! (Pos 3 2) == Just O && b ! (Pos 3 3) == Just O && (Pos 3 1) `elem`(emptyPositions b)
    then return (Pos 3 1)
  else if b ! (Pos 1 3) == Just O && b ! (Pos 2 3) == Just O && (Pos 3 3) `elem`(emptyPositions b)
    then return (Pos 3 3)
  else if b ! (Pos 2 3) == Just O && b ! (Pos 3 3) == Just O && (Pos 1 3) `elem`(emptyPositions b)
    then return (Pos 1 3)
  else if b ! (Pos 1 3) == Just O && b ! (Pos 3 3) == Just O && (Pos 2 3) `elem`(emptyPositions b)
    then return (Pos 2 3)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 2 2) == Just O && (Pos 3 3) `elem`(emptyPositions b)
    then return (Pos 3 3)
  else if b ! (Pos 1 1) == Just O && b ! (Pos 3 3) == Just O && (Pos 2 2) `elem`(emptyPositions b)
    then return (Pos 2 2)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 3 3) == Just O && (Pos 1 1) `elem`(emptyPositions b)
    then return (Pos 1 1)
  else if b ! (Pos 1 3) == Just O && b ! (Pos 2 2) == Just O && (Pos 3 1) `elem`(emptyPositions b)
    then return (Pos 3 1)
  else if b ! (Pos 1 3) == Just O && b ! (Pos 3 1) == Just O && (Pos 2 2) `elem`(emptyPositions b)
    then return (Pos 2 2)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 3 1) == Just O && (Pos 1 3) `elem`(emptyPositions b)
    then return (Pos 1 3)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 1 2) == Just O && (Pos 3 2) `elem`(emptyPositions b)
    then return (Pos 3 2)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 3 2) == Just O && (Pos 1 2) `elem`(emptyPositions b)
    then return (Pos 1 2)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 2 1) == Just O && (Pos 2 3) `elem`(emptyPositions b)
    then return (Pos 2 3)
  else if b ! (Pos 2 2) == Just O && b ! (Pos 2 3) == Just O && (Pos 2 1) `elem`(emptyPositions b)
    then return (Pos 2 1)
    ...
    then return (Pos 1 3)
  else if b ! (Pos 2 2) == Just X && b ! (Pos 1 2) == Just X && (Pos 3 2) `elem`(emptyPositions b)
    then return (Pos 3 2)
  else if b ! (Pos 2 2) == Just X && b ! (Pos 3 2) == Just X && (Pos 1 2) `elem`(emptyPositions b)
    then return (Pos 1 2)
  else if b ! (Pos 2 2) == Just X && b ! (Pos 2 1) == Just X && (Pos 2 3) `elem`(emptyPositions b)
    then return (Pos 2 3)
  else if b ! (Pos 2 2) == Just X && b ! (Pos 2 3) == Just X && (Pos 2 1) `elem`(emptyPositions b)
    then return (Pos 2 1)
  else if b ! (Pos 1 2) == Just X && b ! (Pos 2 1) == Just X && (Pos 1 1) `elem`(emptyPositions b)
    then return (Pos 1 1)
  else if b ! (Pos 1 2) == Just X && b ! (Pos 2 3) == Just X && (Pos 1 3) `elem`(emptyPositions b)
    then return (Pos 1 3)
  else if b ! (Pos 2 1) == Just X && b ! (Pos 3 2) == Just X && (Pos 3 1) `elem`(emptyPositions b)
    then return (Pos 3 1)
  else if b ! (Pos 2 3) == Just X && b ! (Pos 3 2) == Just X && (Pos 3 3) `elem`(emptyPositions b)
    then return (Pos 3 3)
  else if b ! (Pos 2 2) == Just X && (Pos 1 1) `elem`(emptyPositions b)
    then return (Pos 1 1)
  else 
